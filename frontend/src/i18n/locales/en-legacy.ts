export default {
  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        claudeOAuthSystemPromptBlocksPlaceholder: 'Leave empty to use the built-in 3 blocks. Supports an array or a JSON object with a blocks field.',
  ...
  payment: {
    ...
    admin: {
      ...
      exportOrders: 'Download paid orders',
      exportStartDate: 'Start date',
      exportEndDate: 'End date',
      exportDateRangeInvalid: 'End date must not be earlier than start date',
