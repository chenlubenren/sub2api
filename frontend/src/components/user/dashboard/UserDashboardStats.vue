...
const todaySavedRmb = computed(() => todayAccountCost.value * 6.7 - (props.stats?.today_actual_cost || 0))
const totalSavedRmb = computed(() => totalAccountCost.value * 6.7 - (props.stats?.total_actual_cost || 0))
