    ...
    <div class="flex h-16 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <div class="flex min-w-0 items-center gap-1 sm:gap-3">
        ...
        <a
          ...
          class="hidden items-center gap-1.5 rounded-lg border-2 border-white px-2.5 py-1.5 text-sm font-bold text-white transition-colors hover:bg-[#d4a533] hover:text-[#101010] sm:flex"
        >
        ...
        <div
          v-if="user"
          class="group relative hidden items-center gap-2 border-2 border-white bg-[#d4a533] px-3 py-1.5 text-[#101010] sm:flex"
        >
          <svg
