...
type User struct {
	...
	// RegistrationPromoGroup is the human-readable group label from the first
	// registration promo code used by this user. It is populated for admin views.
	RegistrationPromoGroup string
