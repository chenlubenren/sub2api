...
// validateInlineImageDataURIs enforces the existing inline image byte limit
// before a request is forwarded upstream. File uploads remain the escape hatch
// for larger payloads.
...
// ValidateInlineImageDataURIsForCompatibility keeps the validator available
// to compatibility tests and integrations without exposing its internals.
