...
// was not loaded in eager-loading.
func (e UserEdges) FileObjectsOrErr() ([]*FileObject, error) {
	if e.loadedTypes[1] {
...
// QueryFileObjects queries the "file_objects" edge of the User entity.
func (_m *User) QueryFileObjects() *FileObjectQuery {
	return NewUserClient(_m.config).QueryFileObjects(_m)
}
